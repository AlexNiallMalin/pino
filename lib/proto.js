...
function child (bindings, opts = {}) {
  ...
  if (opts.redact !== null && typeof opts.redact === 'object') {
    const { paths, censor } = redaction.handle(opts.redact)
    const stringifiers = this[stringifiersSym]
    const childStringifiers = redaction({ paths, censor, parent: stringifiers }, stringify)
    instance[stringifiersSym] = childStringifiers
  }
